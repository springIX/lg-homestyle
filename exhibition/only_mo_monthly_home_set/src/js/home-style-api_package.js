(() => {
  ...
  class HomeStyleProductUIController {
    ...
    #updateProductCard(elItem, data) {
      ...
      // Price fallback: 정상가 DOM이 없으면 혜택가로라도 무조건 노출
    ...
    /**
     * 정상가(.c-product__price-item--original)가 없을 경우,
     * 혜택가(.c-product__price-value--member)를 이용해 가격이 항상 노출되도록 보정
     * @param {Element} elItem
     */
